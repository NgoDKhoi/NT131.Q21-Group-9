  ...
  const int speedForward  = 180; // Safe high speed (max 255) for forward/backward to avoid brownout
  const int speedTurn     = 180; // Safe high speed (max 255) for turning to avoid brownout
